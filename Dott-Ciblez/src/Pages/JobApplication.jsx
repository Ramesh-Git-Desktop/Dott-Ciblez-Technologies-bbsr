...
export const jobsData = [
    { id: 1, title: "Senior Full Stack Developer", dept: "Engineering", location: "NYC / Remote", type: "Full-time", salary: "$120k – $160k", icon: "bi-code-slash", color: "#2563eb" },
    { id: 2, title: "UI/UX Designer", dept: "UI/UX Design", location: "Remote", type: "Full-time", salary: "$90k – $120k", icon: "bi-palette", color: "#db2777" },
    { id: 3, title: "Digital Marketing Specialist", dept: "Marketing", location: "Remote", type: "Full-time", salary: "$70k – $95k", icon: "bi-bar-chart", color: "#ca8a04" },
    { id: 4, title: "IT Desk Support Engineer", dept: "IT Desk Support", location: "NYC", type: "Full-time", salary: "$60k – $80k", icon: "bi-headset", color: "#059669" },
    { id: 5, title: "HR & Accounting Executive", dept: "Accounting", location: "Remote", type: "Full-time", salary: "$65k – $85k", icon: "bi-calculator", color: "#4f46e5" },
    { id: 6, title: "Business Developer Executive", dept: "Engineering", location: "NYC", type: "Full-time", salary: "$85k – $110k", icon: "bi-briefcase", color: "#2563eb" },
    { id: 7, title: "Product Analyst", dept: "Engineering", location: "Remote", type: "Full-time", salary: "$80k – $105k", icon: "bi-graph-up", color: "#2563eb" },
];
...
const JobApplication = () => {
    ...
    const canSubmit = agreeTerms && Object.values(confirmChecks).every(Boolean);
                    ...
                    <div className="apply-forms">
                            ...
                            <div className="card-body">
                                ...
                                <div className="form-row-2">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" placeholder={`e.g. ${job.title}`} />
                                    </div>
                                    <div className="form-group">
                                ...
                                <div className="form-row-1 form-row-wide">
                                    <div className="form-group">
                                        ...
                                        <input className="form-control" placeholder="linkedin.com/in/username" />
                                    </div>
                                </div>
                                <div className="btn-row">
                        ...
                        <div className="submit-area">
                            ...
                            <button
                                ...
                                disabled={!canSubmit}
                            >
                                {canSubmit ? "Submit Application →" : "Complete all fields to submit"}
                            </button>
                        </div>
