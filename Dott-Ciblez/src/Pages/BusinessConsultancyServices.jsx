...
const BusinessConsultancyServices = () => {
    ...
    return (
        <div className="consultancy">
            ...
            <section className="cons-modern-tech">

                <div className="cons-tech-header">
                    <motion.span 
                        className="cons-tech-label"
                        initial={{ opacity: 0, scale: 0.9 }}
                        whileInView={{ opacity: 1, scale: 1 }}
                        transition={{ duration: 0.5 }}
                    >
                        <FaCheckCircle className="cons-label-check" /> ELITE TECHNICAL EXPERTISE
                    </motion.span>
                ...
                <div className="cons-tech-grid">

                    <motion.div 
                        className="cons-tech-card"
                        initial={{ opacity: 0, y: 40 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.1 }}
                    >
                        <div className="cons-tech-card-body">
                            <div className="cons-tech-icon"><FaChartLine /></div>
                            <h4>Business Analytics</h4>
                            <p>Data-driven decision making with enterprise-grade visualization tools.</p>
                            <div className="cons-tech-tags">
                                <span>Power BI</span>
                                <span>Tableau</span>
                                <span>Looker</span>
                            </div>
                        </div>
                        <img className="cons-tech-img" src="https://images.unsplash.com/photo-1551288049-bebda4e38f71?auto=format&fit=crop&w=900&q=80" alt="analytics" />
                    </motion.div>
                    ...
                    >
                        <div className="cons-tech-card-body">
                            <div className="cons-tech-icon"><FaProjectDiagram /></div>
                        ...
                        <img className="cons-tech-img" src="https://images.unsplash.com/photo-1552664730-d307ca884978?auto=format&fit=crop&w=900&q=80" alt="pm" />
                    </motion.div>
                    ...
                    >
                        <div className="cons-tech-card-body">
                            <div className="cons-tech-icon"><FaRobot /></div>
                        ...
                        <img className="cons-tech-img" src="https://images.unsplash.com/photo-1581092335397-9583eb92d232?auto=format&fit=crop&w=900&q=80" alt="automation" />
                    </motion.div>
                    ...
                    >
                        <div className="cons-tech-card-body">
                            <div className="cons-tech-icon"><FaCloud /></div>
                        ...
                        <img className="cons-tech-img" src="https://images.unsplash.com/photo-1558494949-ef010cbdcc31?auto=format&fit=crop&w=900&q=80" alt="cloud platforms" />
                    </motion.div>
                    ...
                    >
                        <div className="cons-tech-card-body">
                            <div className="cons-tech-icon"><FaCity /></div>
                        ...
                        <img className="cons-tech-img" src="https://images.unsplash.com/photo-1454165804606-c3d57bc86b40?auto=format&fit=crop&w=900&q=80" alt="enterprise" />
                    </motion.div>

                    <motion.div 
                        className="cons-tech-card cons-special-integration"
                        initial={{ opacity: 0, y: 40 }}
                        whileInView={{ opacity: 1, y: 0 }}
                        transition={{ duration: 0.5, delay: 0.6 }}
                    >
                        <div className="cons-tech-card-body">
                            <div className="cons-tech-icon cons-blue-bg"><FaCode /></div>
                            <h4>Custom Integration</h4>
                            <p>Need a custom technical architecture tailored to your specifics?</p>
                            <a href="#" className="cons-tech-link">Explore Custom Solutions &rarr;</a>
                        </div>
                    </motion.div>
