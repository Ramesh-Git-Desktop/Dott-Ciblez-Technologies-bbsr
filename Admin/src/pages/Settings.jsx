                ...
                <div className="card-body">
                  <div style={{ maxWidth: 400 }}>
                    <div className="form-group">
                      ...
                      <input type="password" className="form-control" value={pass.old} onChange={e => setPass({ ...pass, old: e.target.value })} placeholder="••••••••" />
                    </div>
                    <div className="form-group">
                      <label className="form-label">New Password</label>
                      <input type="password" className="form-control" value={pass.new} onChange={e => setPass({ ...pass, new: e.target.value })} placeholder="••••••••" />
                    </div>
                    <div className="form-group" style={{ marginBottom: 24 }}>
                      <label className="form-label">Confirm Password</label>
                      <input type="password" className="form-control" value={pass.confirm} onChange={e => setPass({ ...pass, confirm: e.target.value })} placeholder="••••••••" />
                    </div>
