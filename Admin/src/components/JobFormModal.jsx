...
const JobFormModal = ({ show, onClose, editJob, form, setForm, onSave }) => {
  if (!show) return null;
    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
        ...
        <div className="modal-footer">
          ...
          <button className="btn btn-primary" onClick={onSave}><Icon name="check" size={13} /> {editJob ? 'Save Changes' : 'Create Job'}</button>
        </div>
      </div>
    </div>
  );
